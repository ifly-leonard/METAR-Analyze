<html>
   ...
   <body> 
      <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
         <h5 class="my-0 mr-md-auto font-weight-normal">Decoded METAR</h5>
      </div>
      <?php
      ...
      <div class="col-md-6 col-lg-6">
		<div class="block">
    		...
    		<ul class="list-unstyled">
    			<li><span class="label label-primary">Station ID :</span> <?php echo $stationid;?> (<?php echo $stationname;?>/<?php echo $stationcountry ;?>)</li><br>
    ...
    <div class="row">
      <div class="col-12 col-md">
        <small class="d-block mb-3 text-muted">METAR decoding site &bull; Created by Manivannan G. <a href="index.php">Homepage</a> | <a href="decode.php">Decode Page </a></small>
      </div>
    </div>
  </footer>
      </div>
